...
public class fragB extends Fragment {
    ...
    private void LoadRecyclerViewData() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        fragB.moneyAPI moneyAPI = retrofit.create( fragB.moneyAPI.class);
        Call<fragB.ResultModel> connection = moneyAPI.getposts();
        connection.enqueue( new Callback<fragB.ResultModel>() {
            @Override
            public void onResponse(Call<fragB.ResultModel> call, retrofit2.Response<fragB.ResultModel> response) {
            ...
            @Override
            public void onFailure(Call<fragB.ResultModel> call, Throwable t) {
                AlertDialog.Builder builder;
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    builder = new AlertDialog.Builder(getActivity(), android.R.style.Theme_Material_Dialog_Alert);
                } else {
    ...
    public interface moneyAPI{
        @POST("GetMoneyNotification.php")
        Call<fragB.ResultModel> getposts();
    }
